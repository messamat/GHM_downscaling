...
def flow_accumulation(in_flowdir_path, in_pixarea_path. out_flowacc_path, out_upstreamarea_path):
    ...
    arcpy.Clip_management(in_raster=in_pixarea_path, out_raster='in_memory/pixarea',
    ...
    (Raster('in_memory/pixarea') + outFlowAccumulation).save(out_upstreamarea_path)
